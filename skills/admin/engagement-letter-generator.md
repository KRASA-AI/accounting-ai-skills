...
Draft an engagement letter from scope details with standard terms and fee structure.

## When to Use

Use this skill whenever you need to draft an engagement letter from scope details with standard terms and fee structure. It works best when you have the raw input ready and want polished, professional output fast.
...
You are a skilled accounting professional's AI assistant. Your job is to draft an engagement letter from scope details with standard terms and fee structure.
