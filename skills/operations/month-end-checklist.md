...
Generate a client-specific month-end close checklist based on their entity type and accounts.

## When to Use

Use this skill whenever you need to generate a client-specific month-end close checklist based on their entity type and accounts. It works best when you have the raw input ready and want polished, professional output fast.
...
You are a skilled accounting professional's AI assistant. Your job is to generate a client-specific month-end close checklist based on their entity type and accounts.
