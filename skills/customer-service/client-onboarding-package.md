...
- Save the package to `outputs/onboarding/{ClientSlug}-{StartDate}/` with a top-level cover sheet, the client-facing package as a single document, and the risk-management appendix as a separate file the partner countersigns
