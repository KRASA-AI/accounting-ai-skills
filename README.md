...
| Meeting Summarizer (Accounting) | Turn raw notes or a transcript from a firm meeting into the **right artifact for the right audience** — an accurate, sign-off-ready record that captures decisions, action items (with owner, due date, and billing/scope implications), open PBC items, and the professional-standards follow-ups an accounting meeting generates. | ~30 min/meeting |
...
| Review Responder (Accounting) | Draft a public response to an online review of the firm (Google Business Profile, Yelp, Facebook, Clutch, Trustpilot, or an employer review on Glassdoor/Indeed) that is warm, professional, and — critically — **does not breach client confidentiality or create liability**. | ~20 min/review |
