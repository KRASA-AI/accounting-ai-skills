...
**Free, open-source AI prompts and workflows built for accountants.** Clone this repo, run the setup wizard, and start saving hours every week.
...
**Total time saved per use: ~110+ minutes across all skills.**
