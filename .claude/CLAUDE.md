...
You are working inside the **Accounting AI Skills** repository by [KRASA AI](https://krasa.ai).

## What this repo is

A complete AI skills toolkit for accountants. It contains:
...
- Industry page: https://krasa.ai/industries/accounting
